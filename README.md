...
- Customer-callable Skill count: 63
...
P1/P2 expanded Skills keep strict runtime boundaries: mock/read-only/dry-run by default, no real account access, no key in repo, no sending, no upload, no business-system writes, and no external action unless a later platform harness explicitly enables it.
